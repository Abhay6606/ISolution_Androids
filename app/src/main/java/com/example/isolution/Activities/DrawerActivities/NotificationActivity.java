...
public class NotificationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                redirectActivity(NotificationActivity.this, MainActivity2.class);            }
        });
        ...
        nearbyMe.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                redirectActivity(NotificationActivity.this, NearbyMeActivity.class);
            }
        });
        favourite.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                redirectActivity(NotificationActivity.this, FavouriteActivity.class);
        ...
        logout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                redirectActivity(NotificationActivity.this, LogoutActivity.class);
        ...
        promotion.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                redirectActivity(NotificationActivity.this, PromotionActivity.class);
            }
        });
        help.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                redirectActivity(NotificationActivity.this, HelpActivity.class);
