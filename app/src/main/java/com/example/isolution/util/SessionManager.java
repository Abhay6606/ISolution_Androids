package com.example.isolution.util;
...
public class SessionManager {
    ...
    private static String BUREAU_ACK_ID = "bureau_ack_id";
   ...
   public static void savePreference(SharedPreferences prefs, String key, Boolean value) {
    ...
    public static void save_access_token(SharedPreferences prefs, String value) {
    ...
    public static void save_expirein(SharedPreferences prefs, String value) {
    ...
    public  static void save_token_type(SharedPreferences prefs, String value) {
    ...
    public static void save_refresh_token(SharedPreferences prefs, String value) {
    ...
    public static void save_secret_key(SharedPreferences prefs, String value) {
        SessionManager.savePreference(prefs, SECRET_KEY, value);
    }

    public static String get_secret_key(SharedPreferences prefs) {
    ...
    static void save_bureau_ack_id(SharedPreferences prefs, String value) {
        SessionManager.savePreference(prefs, BUREAU_ACK_ID, value);
    }

    static String get_bureau_ack_id(SharedPreferences prefs) {
        return prefs.getString(BUREAU_ACK_ID, "");
    }
